...
export default {
  props: {
    orgUuid: { type: String },
    coinbaseCommerceAccount: { type: Object }
  },
  data () {
    return {
      coinbaseCommerceAccount__: StripeAccount.make()
    }
  },
  watch: {
    coinbaseCommerceAccount: {
      immediate: true,
      handler (value) {
        this.coinbaseCommerceAccount__ = StripeAccount.make(value)
      }
    }
  },
  computed: {
    exists () {
      return this.coinbaseCommerceAccount__?.exists() ?? false
    },
  },
}
</script>
